...
from model import BaseLine, BaseLine_two_class, BaseLine_enc_dec
...
class Trainer(object):
    ...
    def __init__(self, hdfs_host: str = None, device: str = 'cpu'):
        ...
        self.model = BaseLine_enc_dec(256, 3, 0.2, self.task.max_vocab_indexes['original_sample'], 384)
    ...
    def train(self):
        print("THIS IS Baseline Masked LM TRAINER")
        max_epoch = 32
        ...
        for epoch in range(max_epoch):
            ...
            for i, batch in tq_iter:
                ...
                pred = self.model(batch.masked_sample)
