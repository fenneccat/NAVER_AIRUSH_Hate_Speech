...
class Trainer(object):
    ...
    def __init__(self, hdfs_host: str = None, device: str = 'cpu', num_models = 2):
        ...
        nsml.load(checkpoint='3', session='fenneccat/hate_3/551')  ## ======= 여기까지 모델 메모리 정리함
        bind_model(self.models[26])  # shuffle 20
        nsml.load(checkpoint='5', session='fenneccat/hate_3/677')
...
if __name__ == '__main__':
    ...
    if args.pause:
        ...
        nsml.load(checkpoint='3', session='fenneccat/hate_3/551') ## ======= 여기까지 모델 메모리 정리함
        bind_model(models[26])  # shuffle 20
        nsml.load(checkpoint='5', session='fenneccat/hate_3/677')
        #bind_model(models[26])  # shuffle 21
        #nsml.load(checkpoint='3', session='fenneccat/hate_3/622')
        #bind_model(models[27])  # shuffle 22
        #nsml.load(checkpoint='24', session='fenneccat/hate_3/623')
        #bind_model(models[28])  # shuffle 23
        #nsml.load(checkpoint='9', session='fenneccat/hate_3/624')
        #bind_model(models[29])  # shuffle 24
        #nsml.load(checkpoint='6', session='fenneccat/hate_3/625')
        #bind_model(models[30])  # shuffle 25
        #nsml.load(checkpoint='4', session='fenneccat/hate_3/626')
        #bind_model(models[31])  # shuffle 26
        #nsml.load(checkpoint='7', session='fenneccat/hate_3/627')
        #bind_model(models[32])  # shuffle 27
        #nsml.load(checkpoint='6', session='fenneccat/hate_3/629')
        #bind_model(models[33])  # shuffle 28
        #nsml.load(checkpoint='16', session='fenneccat/hate_3/630')
        #bind_model(models[34])  # shuffle 29
        #nsml.load(checkpoint='2', session='fenneccat/hate_3/631')
        #bind_model(models[26])  # shuffle 30
        #nsml.load(checkpoint='8', session='fenneccat/hate_3/632')
        #bind_model(models[36])  # shuffle 31
        #nsml.load(checkpoint='5', session='fenneccat/hate_3/633')
        #bind_model(models[37])  # shuffle 32
        #nsml.load(checkpoint='5', session='fenneccat/hate_3/634')
    ...
    if args.mode == 'train':
        trainer = Trainer(device='cuda', num_models=27)
        print("trainer")
        trainer.train()