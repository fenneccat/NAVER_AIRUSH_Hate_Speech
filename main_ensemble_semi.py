...
class Trainer(object):
    ...
    def __init__(self, hdfs_host: str = None, device: str = 'cpu', num_models = 2):
        ...
        nsml.load(checkpoint='24', session='fenneccat/hate_3/524')
        bind_model(self.models[1])  # shuffle 2
        nsml.load(checkpoint='36', session='fenneccat/hate_3/525')
        bind_model(self.models[2])  # shuffle 3
        nsml.load(checkpoint='47', session='fenneccat/hate_3/526')
        bind_model(self.models[3])  # shuffle 4
        nsml.load(checkpoint='50', session='fenneccat/hate_3/520')
        bind_model(self.models[4])  # shuffle 5
        nsml.load(checkpoint='55', session='fenneccat/hate_3/529')
