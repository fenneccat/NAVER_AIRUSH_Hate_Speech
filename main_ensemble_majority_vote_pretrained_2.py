...
if __name__ == '__main__':
    ...
    if args.pause:
        ...
        nsml.load(checkpoint='5', session='fenneccat/hate_3/658')
        bind_model(models[4])  # shuffle 6
        nsml.load(checkpoint='4', session='fenneccat/hate_3/660')
        bind_model(models[5])  # shuffle 7
        nsml.load(checkpoint='4', session='fenneccat/hate_3/661')
        bind_model(models[6])  # shuffle 8
        nsml.load(checkpoint='7', session='fenneccat/hate_3/662')
        bind_model(models[7])  # shuffle 9
        nsml.load(checkpoint='1', session='fenneccat/hate_3/665')
        bind_model(models[8])  # shuffle 10
        nsml.load(checkpoint='7', session='fenneccat/hate_3/666')
        bind_model(models[9])  # shuffle 11
        nsml.load(checkpoint='1', session='fenneccat/hate_3/667') ## 조금 낮은편 90
        bind_model(models[10])  # shuffle 14
        nsml.load(checkpoint='1', session='fenneccat/hate_3/670')
        bind_model(models[11])  # shuffle 16
        nsml.load(checkpoint='2', session='fenneccat/hate_3/672')
        bind_model(models[12])  # shuffle 18
        nsml.load(checkpoint='7', session='fenneccat/hate_3/675')
        bind_model(models[13])  # shuffle 19
        nsml.load(checkpoint='3', session='fenneccat/hate_3/676')
        bind_model(models[14])  # shuffle 20
        nsml.load(checkpoint='5', session='fenneccat/hate_3/677') #0.978961298
        bind_model(models[15])  # shuffle 21
        nsml.load(checkpoint='5', session='fenneccat/hate_3/678')
        bind_model(models[16])  # shuffle 22
        nsml.load(checkpoint='2', session='fenneccat/hate_3/679')
        bind_model(models[17])  # shuffle 23
        nsml.load(checkpoint='5', session='fenneccat/hate_3/680')
        bind_model(models[18])  # shuffle 24
        nsml.load(checkpoint='8', session='fenneccat/hate_3/681')
        bind_model(models[19])  # shuffle 26
        nsml.load(checkpoint='2', session='fenneccat/hate_3/684')
    ...
    if args.mode == 'train':
        trainer = Trainer(device='cuda', num_models=20)
        print("trainer")
        trainer.train()